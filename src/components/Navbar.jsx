          ...
          <nav className="navBar">
            <div className="navContent">
              ...
              <div className="logoBox">
                  <Link to="/"><img onClick={() => setBarState(false)} className="logo" src="https://www.freetogame.com/assets/images/freetogame-logo.png" alt=""></img></Link>
              </div>
              ...
              <div className='navBox'>
              <button className="navInputButton" onClick={() => {inputActive(), setBarState(false)}}>
